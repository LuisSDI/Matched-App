...
class MajorScreen extends StatelessWidget {
  ...
  MajorScreen(
      ...
      @required this.majorReq,
      @required this.majorElec,
      @required this.detail,
      @required this.pictures,
      @required this.specialElec,
      @required this.studentPicture,
      @required this.studentName,
      @required this.studentCountry,
      @required this.studentOpinion})
      : super(key: key);
  @override
            ...
            (majorElec.isEmpty)
                ...
                : Container(
                    ...
                    child: ExpansionItem(
                      ...
                      ), data: '', richText: RichText(text: TextSpan()), key: Key('1234'),
                    ),
                  ),
